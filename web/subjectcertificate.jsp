...
<html class="no-js" lang="zxx">
    ...
    <body >
        <jsp:include page="header3.jsp"></jsp:include> 
            ...
            <main>
                <div>
                    <a href="overview?category_id=${category_id}&subject_id=${subject.subject_id}&course_id=${course_id}" class="btn btn-secondary mt-3"><i class="fa fa-backward"></i> Back to Learning Environment </a>
                    ...
                    <div class="pm-certificate-border">
                        <div class="pm-certificate-header">
                            <div class="pm-certificate-title cursive">
                                <h2 style="font-family: 'Pinyon Script', cursive; font-weight: bold">${subject.subject_name}</h2>
                            </div>
                        </div>
                        <div class="pm-certificate-body">
                            <div class="pm-certificate-block">
                                ...
                                <div class="pm-earned">
                                    <h3 class="pm-earned-text cursive">has successfully completed ${subject.subject_name}</h3>
                ...
                <div style="float: right; margin-right: 220px; margin-top: 20px">
                    <a href="enrolsubject" class="btn btn-secondary mt-1 py-3 px-5"><i class="fa fa-share"></i>  Share </a>
                    <a  id="download" class="btn btn-secondary mt-1 py-3 px-5"><i class="fa fa-download"></i>  Download as Image </a>
                    <a  id="download2" class="btn btn-secondary mt-1 py-3 px-5"><i class="fa fa-download"></i>  Download as PDF </a>
                </div>
            </div>
            <hr>
